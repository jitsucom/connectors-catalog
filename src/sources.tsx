...
export const firebase: SourceConnector = {
    pic: <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="48px" height="48px"><path fill="#ff8f00" d="M8,37L23.234,8.436c0.321-0.602,1.189-0.591,1.494,0.02L30,19L8,37z"/><path fill="#ffa000" d="M8,36.992l5.546-34.199c0.145-0.895,1.347-1.089,1.767-0.285L26,22.992L8,36.992z"/><path fill="#ff6f00" d="M8.008 36.986L8.208 36.829 25.737 22.488 20.793 13.012z"/><path fill="#ffc400" d="M8,37l26.666-25.713c0.559-0.539,1.492-0.221,1.606,0.547L40,37l-15,8.743 c-0.609,0.342-1.352,0.342-1.961,0L8,37z"/></svg>,
    displayName: 'Firebase',
    id: "firebase",
    collectionTypes: ['users', 'firestore_${name_of_collection}'],
    collectionParameters: [],
    configParameters: [
        {
 ...
 */
export const singer: SourceConnector = {
    pic: <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="558.000000pt" height="558.000000pt" viewBox="0 0 558.000000 558.000000" preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,558.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M0 2790 l0 -2790 2790 0 2790 0 0 2790 0 2790 -2790 0 -2790 0 0 -2790z m2229 1034 c114 -32 201 -143 201 -255 0 -62 -36 -139 -90 -190 -40 -39 -59 -50 -114 -62 -59 -13 -73 -13 -123 0 -85 22 -133 60 -175 138 -30 56 -30 175 -1 232 24 46 65 93 82 93 6 0 11 4 11 10 0 9 109 48 138 49 7 1 39 -6 71 -15z m2811 -254 l0 -180 -1120 0 -1120 0 0 180 0 180 1120 0 1120 0 0 -180z m-3533 -560 c60 -37 100 -86 122 -152 25 -75 26 -85 4 -151 -40 -124 -128 -190 -253 -191 -53 0 -75 5 -118 29 -30 16 -65 43 -78 60 -13 16 -29 35 -34 42 -33 41 -35 183 -3 250 26 56 109 125 164 136 56 12 157 0 196 -23z m3528 -215 l0 -180 -1510 0 -1510 0 -3 170 c-1 93 0 175 2 182 4 11 289 13 1513 11 l1508 -3 0 -180z m-1954 -538 c80 -39 130 -110 137 -192 10 -133 -27 -213 -125 -271 -42 -24 -58 -28 -128 -28 -69 0 -86 4 -127 28 -156 91 -184 293 -57 417 84 81 194 98 300 46z m1957 -234 l2 -183 -720 0 -720 0 0 185 0 185 718 -2 717 -3 3 -182z"/> </g> </svg>,
    displayName: 'Singer',
    id: "singer",
    collectionTypes: [],
    collectionParameters: [],
