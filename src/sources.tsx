...
export const googleAnalytics: SourceConnector = {
    ...
    collectionParameters: [
        {
            displayName: "Dimenensions",
            id: "fields",
            type: selectionType([ "ga:pagePath", "ga:browser", "ga:browserVersion", "ga:sourceMedium", "ga:country", "ga:city" ])
        },
        {
            displayName: "Metrics",
            id: "fields",
            type: selectionType([ "ga:users", "ga:sessions", "ga:hits" ])
        }
